> [!NOTE]
> This changelog has been cut-off from [zacharee/AndroidPdfViewer](https://github.com/zacharee/AndroidPdfViewer)'s fork for preservation.
>
> - Please see this [CHANGELOG.md](../CHANGELOG.md) for the most up-to-date information regarding this fork
