> [!NOTE]
>
> This changelog includes information about the other forks this repository is based on.
> - This verison of the changelog has been archived in favor of the root [`CHANGELOG.md`](../CHANGELOG.md) file which only includes up-to-date inforamtion.
